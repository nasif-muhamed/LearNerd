...
const AdminDashboard = () => {
  ...
  // Sample user data
  const users = [
    { id: '#1234', name: 'Samantha Melon', img: '/api/placeholder/40/40', trend: 'up' },
    { id: '#1234', name: 'Jimmy Changa', img: '/api/placeholder/40/40', trend: 'down' },
    { id: '#1234', name: 'Gabe Lackmen', img: '/api/placeholder/40/40', trend: 'up' },
    { id: '#1234', name: 'Manuel Labor', img: '/api/placeholder/40/40', trend: 'down' },
    { id: '#1234', name: 'Sharon Needles', img: '/api/placeholder/40/40', trend: 'up' },
  ];
    ...
    <div className="bg-gray-900 text-white p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-blue-600 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">TOTAL COURSES</h3>
          <p className="text-center text-4xl font-bold">109</p>
        </div>
        <div className="bg-red-500 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">TOTAL STUDENTS</h3>
          <p className="text-center text-4xl font-bold">+1023</p>
        </div>
        <div className="bg-gray-200 text-gray-900 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">TOTAL TUTORS</h3>
          <p className="text-center text-4xl font-bold">+20</p>
        </div>
        <div className="bg-green-500 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">TOTAL SUBSCRIPTION</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-200 text-gray-900 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">TOTAL FREEMIUM</h3>
          <p className="text-center text-4xl font-bold">3552</p>
        </div>
        <div className="bg-green-500 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">FEES COLLECTED</h3>
          <p className="text-center text-4xl font-bold">₹44,45,880</p>
        </div>
        <div className="bg-blue-600 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">COMMISSION ON FEES</h3>
          <p className="text-center text-4xl font-bold">₹3,40,000</p>
        </div>
        <div className="bg-red-500 p-4 rounded-lg">
          <h3 className="text-center text-lg font-medium">AD REVENUE</h3>
        ...
        <div className="lg:col-span-2 bg-gray-800 p-4 rounded-lg">
          <div className="flex justify-between mb-4">
            <div className="flex space-x-4">
              <div>
                <span className="block text-2xl font-semibold">150</span>
              ...
              <div>
                <span className="block text-2xl font-semibold">295</span>
                <div className="flex items-center">
              ...
              <div>
                <span className="block text-2xl font-semibold">250</span>
                <div className="flex items-center">
          ...
          <div className="space-y-4">
            {users.map((user, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <div className={`w-16 h-8 ${user.trend === 'up' ? 'text-green-500' : 'text-red-500'}`}>
                  {user.trend === 'up' ? (
                    <svg className="w-full h-full" viewBox="0 0 100 30" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 30 L10 20 L30 25 L50 10 L70 15 L90 5 L100 10" fill="none" stroke="currentColor" strokeWidth="2" />
                    </svg>
                  ) : (
                    <svg className="w-full h-full" viewBox="0 0 100 30" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 10 L20 20 L40 5 L60 15 L80 10 L100 25" fill="none" stroke="currentColor" strokeWidth="2" />
                    </svg>
                  )}
                </div>
              </div>
