  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground">
      ...
      <div className="flex-1 flex">
        {/* Video area */}
        <div className={`flex-1 bg-card relative ${isChatOpen ? 'lg:mr-80' : ''}`}>
          {/* Remote video (large) */}
          ...
          {/* Local video (small) */}
          <div className="absolute bottom-6 right-6 w-48 h-36 rounded-lg overflow-hidden border-2 border-border shadow-lg">
            <video
              ref={localVideoRef}
              autoPlay
              playsInline
