...
const HeaderAuth = ({ toggleSidebar, role }) => {
                ...
                >
                    ...
                    <div className="relative w-full">
                        ...
                        <button 
                            ...
                            className="absolute right-0 top-0 h-full px-4 bg-primary hover:bg-opacity-90 text-primary-foreground rounded-r-md transition-all duration-300"
                        >
                            <Search />
                        </button>
                        {isSearchExpanded && (
    ...
    <div className="hidden md:flex items-center space-x-6">
        ...
        <Link to={'/notifications'} className="text-foreground text-2xl hover:text-accent transition-colors duration-300">
            <Bell />
        </Link>
