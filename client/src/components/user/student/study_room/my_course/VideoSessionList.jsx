        ...
        return (
            <div className="transaction-card flex flex-col items-start justify-between gap-3">
                ...
                <StatusBadge status={session.status} />
                        ...
                        <div className="text-sm text-muted-foreground mt-1 space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span>
                                    Created:{" "}
                                    {formatDateMonth(session.created_at)}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-2 w-auto justify-end mt-0">
                    ...
                    {/* {session.status === "approved" && (
                        <button onClick={() => handleJoinRoom(session.id)} className="btn-primary flex items-center text-xs" disabled={joinLoading}>
                ...
                <div className="space-y-4">
                    {videoSessions.map((session, idx) => (
                        <SessionCard
                            key={idx}
                            session={session}
                            number={videoSessions.length - idx}
                        />
                    ))}
                </div>
            ) : (
